{
  ...
  "additional_scripts": [
    ...
    "openspace.navigation.loadNavigationState('${USER}/data/assets-dev/flight-practice/marsflight2start.txt')"
  ],
  "assets": [
    "baseReduced",
    "scene/solarsystem/planets/earth/earth",
    "${USER}/data/assets-dev/flight-practice/make-targets-for-mars-flight-2"
  ],
  "camera": {
    "altitude": 15000000.0,
    "anchor": "Mars",
